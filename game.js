...
Each crystal should have a random hidden value between 1 - 15.*/
...
$(document).ready(function () {
  ...
  for (var i = 0; i < numberOne.length; i++) {
    ...
    image1.attr('src', './assets/css/images/image-1.jpg');
  ...
  for (var i = 0; i < numberTwo.length; i++) {
    ...
    image2.attr('src', './assets/css/images/image-2.jpg');
  ...
  for (var i = 0; i < numberThree.length; i++) {
    ...
    image3.attr('src', './assets/css/images/image-3.jpg');
  ...
  for (var i = 0; i < numberFour.length; i++) {
    ...
    image4.attr('src', './assets/css/images/image-4.jpg');
